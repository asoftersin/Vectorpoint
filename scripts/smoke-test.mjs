...
const checks = [
  ...
  ["pipeline diagram cropped to content", html.includes('viewBox="20 95 1185 415"') && html.includes('class="flow__scroll"') && css.includes(".flow__scroll svg { min-width: 720px; }")],
  ...
  ["tighter page rhythm", css.includes("padding: clamp(56px, 7vw, 96px) var(--pad-x)") && css.includes("height: 160vh")],
